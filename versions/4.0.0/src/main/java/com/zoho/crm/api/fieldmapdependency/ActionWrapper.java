...
public class ActionWrapper implements Model, ActionHandler
{
	 ...
	 */
	public List<ActionResponse> getMapDependency()
	{
	 ...
	 * @param mapDependency An instance of List<ActionResponse>
	 */
	public void setMapDependency(List<ActionResponse> mapDependency)
	{
