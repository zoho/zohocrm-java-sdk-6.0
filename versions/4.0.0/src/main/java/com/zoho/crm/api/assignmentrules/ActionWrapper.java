...
public class ActionWrapper implements Model
{
	 ...
	 */
	public List<APIException> getAssignmentRules()
	{
	 ...
	 * @param assignmentRules An instance of List<APIException>
	 */
	public void setAssignmentRules(List<APIException> assignmentRules)
	{
