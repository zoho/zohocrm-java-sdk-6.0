...
import com.zoho.crm.api.territoryusers.TerritoryUsersOperations.DeassociateTerritoryUsersParam;
import com.zoho.crm.api.util.APIResponse;
import com.zoho.crm.api.util.Model;

public class DeassociateTerritoryUsers 
{
	public static void deassociateTerritoryUsers(Long territory) throws Exception
	{
		TerritoryUsersOperations territoryUsersOperations = new TerritoryUsersOperations();
		ParameterMap paraminstance = new ParameterMap();
		paraminstance.add(DeassociateTerritoryUsersParam.IDS, "440248001305249");
	...
	public static void main(String[] args)
	{
		try
		{
			...
			deassociateTerritoryUsers(territory);
		}
		catch (Exception e)
		{
			e.printStackTrace();
