...
{
	public static void getTerritoryUser(Long user, Long territory) throws Exception
	{
			...
			if (response.isExpected())
			{
				...
				if (responseHandler instanceof ResponseWrapper)
				{
					...
					if (users != null)
					{
						...
						{
							System.out.println("Territory User ID : " + user1.getId());
						}
					}
	...
	public static void main(String[] args)
	{
		try
		{
			...
			long user = 4402480254001l;
			getTerritoryUser(user, territory);
		}
		catch (Exception e)
		{
			e.printStackTrace();
