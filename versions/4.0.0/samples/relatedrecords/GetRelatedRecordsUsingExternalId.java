...
import com.zoho.crm.api.relatedrecords.RelatedRecordsOperations.GetRelatedRecordsUsingExternalIDHeader;
...
public class GetRelatedRecordsUsingExternalId
{
	public static void getRelatedRecordsUsingExternalId(String moduleAPIName, String externalValue, String relatedListAPIName) throws Exception
	{
		...
		headerInstance.add(GetRelatedRecordsUsingExternalIDHeader.IF_MODIFIED_SINCE, startdatetime);
		headerInstance.add(GetRelatedRecordsUsingExternalIDHeader.X_EXTERNAL, xExternal);
