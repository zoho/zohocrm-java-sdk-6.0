...
public class DeleteGlobalPicklist
{
	public static void deleteGlobalPicklist(Long id) throws Exception
	{
		GlobalPicklistsOperations globalPicklistsOperations = new GlobalPicklistsOperations();
		APIResponse<ActionHandler> response = globalPicklistsOperations.deleteGlobalPicklist(id);
		if (response != null)
		{
