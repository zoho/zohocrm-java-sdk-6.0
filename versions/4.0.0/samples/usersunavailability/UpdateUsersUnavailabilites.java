...
{
	public static void updateUsersUnavailability() throws Exception
	{
		...
		APIResponse<ActionHandler> response = usersOperations.updateUsersUnavailability(request);
		if (response != null)
		{
