...
public class CreateUsersUnavailability
{
	public static void createUsersUnavailability() throws Exception
	{
		...
		OffsetDateTime from = OffsetDateTime.of(2023, 10, 02, 11, 00, 01, 00, ZoneOffset.of("+05:30"));
		user1.setFrom(from);
		OffsetDateTime to = OffsetDateTime.of(2023, 10, 02, 11, 00, 01, 00, ZoneOffset.of("+05:30"));
		user1.setTo(to);
		User user = new User();
		user.setId(440248001305249l);
		user1.setUser(user);
		userList.add(user1);
