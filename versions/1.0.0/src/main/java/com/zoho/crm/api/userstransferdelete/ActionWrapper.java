...
public class ActionWrapper implements Model, ActionHandler
{
	 ...
	 */
	public List<ActionResponse> getTransferAndDelete()
	{
	 ...
	 * @param transferAndDelete An instance of List<ActionResponse>
	 */
	public void setTransferAndDelete(List<ActionResponse> transferAndDelete)
	{
