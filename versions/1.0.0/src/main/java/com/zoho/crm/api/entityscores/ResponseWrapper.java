...
public class ResponseWrapper implements Model, ResponseHandler
{
	 ...
	 * @return An instance of List<EntityScores>
	 */
	public List<EntityScores> getData()
	{
		return  this.data;
	 ...
	 * @param data An instance of List<EntityScores>
	 */
	public void setData(List<EntityScores> data)
	{
		 this.data = data;
