...
{
	public static void updateUserType(String portal, String userId) throws Exception
	{
		...
		APIResponse<ActionHandler> response = portalUserTypeOperations.updateUserType(userId, bodyWrapper);
		if (response != null)
		{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			String userId = "34777221008";
			updateUserType(portal, userId);
		}
		catch (Exception e)
		{
			e.printStackTrace();
