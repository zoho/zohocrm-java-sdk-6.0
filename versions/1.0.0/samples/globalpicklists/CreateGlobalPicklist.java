...
public class CreateGlobalPicklist
{
	public static void createGlobalPicklist() throws Exception
	{
		...
		APIResponse<ActionHandler> response = globalPicklistsOperations.createGlobalPicklist(bodyWrapper);
		if (response != null)
		{
