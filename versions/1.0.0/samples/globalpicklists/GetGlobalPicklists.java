...
import com.zoho.crm.api.globalpicklists.GlobalPicklistsOperations.GetGlobalPicklistsParam;
...
public class GetGlobalPicklists
{
	public static void getGlobalPicklists() throws Exception
	{
		GlobalPicklistsOperations sendMailsOperations = new GlobalPicklistsOperations();
		ParameterMap paramInstance = new ParameterMap();
		paramInstance.add(GetGlobalPicklistsParam.INCLUDE, null);
		paramInstance.add(GetGlobalPicklistsParam.INCLUDE_INNER_DETAILS, "used_in_modules.plural_label");
		APIResponse<ResponseHandler> response = sendMailsOperations.getGlobalPicklists(paramInstance);
		if (response != null)
		{
