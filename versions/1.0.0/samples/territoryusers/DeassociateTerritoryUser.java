...
{
	public static void deassociateTerritoryUser(long user, Long territory) throws Exception
	{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			long user = 323242341232312l;
			deassociateTerritoryUser(user, territory);
		}
		catch (Exception e)
		{
			e.printStackTrace();
