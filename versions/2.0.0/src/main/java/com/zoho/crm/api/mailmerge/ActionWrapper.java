...
public class ActionWrapper implements Model, ActionHandler
{
	 ...
	 */
	public List<ActionResponse> getSendMailMerge()
	{
	 ...
	 * @param sendMailMerge An instance of List<ActionResponse>
	 */
	public void setSendMailMerge(List<ActionResponse> sendMailMerge)
	{
