...
public class ActionWrapper implements Model, ActionHandler
{
	 ...
	 */
	public List<ActionResponse> getGlobalPicklists()
	{
	 ...
	 * @param globalPicklists An instance of List<ActionResponse>
	 */
	public void setGlobalPicklists(List<ActionResponse> globalPicklists)
	{
