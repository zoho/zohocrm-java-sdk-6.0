...
public class ActionWrapper implements Model, ActionHandler
{
	 ...
	 */
	public List<ActionResponse> getPortalInvite()
	{
	 ...
	 * @param portalInvite An instance of List<ActionResponse>
	 */
	public void setPortalInvite(List<ActionResponse> portalInvite)
	{
