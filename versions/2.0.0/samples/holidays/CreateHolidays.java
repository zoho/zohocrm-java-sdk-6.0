...
import com.zoho.crm.api.holidays.BusinessHoliday;
import com.zoho.crm.api.holidays.CreateBusinessHoliday;
import com.zoho.crm.api.holidays.CreateShiftHoliday;
...
import com.zoho.crm.api.holidays.ShiftHoliday;
...
public class CreateHolidays
{
	public static void createHolidays() throws Exception
	{
		...
		List<BusinessHoliday> holidays = new ArrayList<>();
		...
		List<ShiftHoliday> shiftholidays = new ArrayList<>();
		...
		shiftholiday.setType(new Choice<String>("shift_holiday"));
		shiftholiday.setDate(LocalDate.of(2023, 8, 22));
