...
{
	public static void deleteAttachments(String moduleAPIName, Long recordId, List<String> attachmentIds) throws Exception
	{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			List<String> attachmentIds = new ArrayList<String>(Arrays.asList("34776001", "3477001"));
