...
public class GetUserLicensesCount
{
	public static void getUserLicensesCount() throws Exception
	{
		FeaturesOperations featuresOperations = new FeaturesOperations();
		APIResponse<ResponseHandler> response = featuresOperations.getUserLicencesCount();
		if (response != null)
		{
					...
					if (features != null)
					{
						for (Feature feature : features)
						{
							...
							if (detail != null)
							{
								...
								Limit availableCount = detail.getAvailableCount();
								if(availableCount != null)
								{
									System.out.println("Feature Detail AvailableCount EditionLimit: " + availableCount.getEditionLimit());
									System.out.println("Feature Detail AvailableCount Total: " + availableCount.getTotal());
								}
								Limit usedCount = detail.getUsedCount();
								if(usedCount != null)
								{
									System.out.println("Feature Detail UsedCount EditionLimit: " + usedCount.getEditionLimit());
									System.out.println("Feature Detail UsedCount Total: " + usedCount.getTotal());
								}
							}
