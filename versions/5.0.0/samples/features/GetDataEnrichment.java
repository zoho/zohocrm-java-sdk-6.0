...
public class GetDataEnrichment
{
	public static void getDataEnrichment() throws Exception
	{
		FeaturesOperations featuresOperations = new FeaturesOperations();
		APIResponse<ResponseHandler> response = featuresOperations.getDataEnrichment();
		if (response != null)
		{
							...
							if(components != null)
							{
								for(Component component : components)
								{
									...
									if (detail != null)
									{
										...
										if(usedCount != null)
										{
											System.out.println("Feature Component Detail UsedCount EditionLimit: " + usedCount.getEditionLimit());
											System.out.println("Feature Component Detail UsedCount Total: " + usedCount.getTotal());
										}
									}
