...
public class UpdateRecordUsingExternalId
{
	public static void updateRecordUsingExternalId(String moduleAPIName, String externalFieldValue) throws Exception
	{
		...
		fileDetail1.setFileIdS("ae9c7cefa418a5c326ef21accd646c01e85c34b1b2e7fe45c");
		fileDetail1.setDelete(null);
		fileDetails.add(fileDetail1);
		FileDetails fileDetail2 = new FileDetails();
		fileDetail2.setFileIdS("ae9c7cefa418a5c326ef21accd646c01e85c34b1b2e7fe45c");
		fileDetail2.setDelete(null);
		fileDetails.add(fileDetail2);
		FileDetails fileDetail3 = new FileDetails();
		fileDetail3.setFileIdS("ae9c7cefa418a5c3256b4b32b984bad140a629d9f4d4fc8e2");
...
//		inventoryLineItem.addKeyValue("Parent_Id", 5);
		...
		APIResponse<ActionHandler> response = recordOperations.updateRecordUsingExternalId(externalFieldValue, request, headerInstance);
		if (response != null)
		{
