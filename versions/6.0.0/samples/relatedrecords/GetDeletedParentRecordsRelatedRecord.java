...
import com.zoho.crm.api.relatedrecords.RelatedRecordsOperations.GetDeletedParentRecordsRelatedRecordParam;
...
{
	public static void getDeletedParentRecordsRelatedRecord(String moduleAPIName, Long recordId, String relatedListAPIName) throws Exception
	{
		...
		paramInstance.add(GetDeletedParentRecordsRelatedRecordParam.PER_PAGE, 2);
		paramInstance.add(GetDeletedParentRecordsRelatedRecordParam.FIELDS, "id");
	...
	public static void main(String[] args)
	{
		try
		{
			...
			Long recordId = 34770827001l;
			String relatedListAPIName = "Products";
			getDeletedParentRecordsRelatedRecord(moduleAPIName, recordId, relatedListAPIName);
		}
		catch (Exception e)
		{
			e.printStackTrace();
