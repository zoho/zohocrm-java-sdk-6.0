...
public class UpdateGlobalPicklists
{
	public static void updateGlobalPicklists() throws Exception
	{
		...
		APIResponse<ActionHandler> response = globalPicklistsOperations.updateGlobalPicklists(bodyWrapper);
		if (response != null)
		{
