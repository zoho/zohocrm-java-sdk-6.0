...
{
	public static void addAppointmentsRescheduledHistory() throws Exception
	{
		...
		rescheduleHistory.setRescheduledTo(OffsetDateTime.of(2023, 11, 20, 11, 30, 01, 00, ZoneOffset.of("+05:30")));
		rescheduleHistory.setRescheduledFrom(OffsetDateTime.of(2023, 11, 20, 9, 30, 01, 00, ZoneOffset.of("+05:30")));
		rescheduleHistory.setRescheduledTime(OffsetDateTime.of(2023, 11, 20, 20, 00, 01, 00, ZoneOffset.of("+05:30")));
	...
	public static void main(String[] args)
	{
		try
		{
			...
			addAppointmentsRescheduledHistory();
		}
		catch (Exception e)
		{
			e.printStackTrace();
