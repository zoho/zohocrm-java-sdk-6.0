...
public class ResponseWrapper implements Model, ResponseHandler
{
	 ...
	 */
	public List<Status> getTransferAndDelete()
	{
	 ...
	 * @param transferAndDelete An instance of List<Status>
	 */
	public void setTransferAndDelete(List<Status> transferAndDelete)
	{
