...
{
	public static void lockARecord(Long recordId, String moduleName) throws Exception
	{
		...
		APIResponse<ActionHandler> response = recordLockingOperations.lockRecords(bodyWrapper);
		if (response != null)
		{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			lockARecord(recordId, moduleAPIName);
		}
		catch (Exception e)
		{
			e.printStackTrace();
