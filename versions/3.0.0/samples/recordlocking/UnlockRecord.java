...
{
	public static void unlockRecord(Long recordId, String moduleName, long lockId) throws Exception
	{
		RecordLockingOperations recordLockingOperations = new RecordLockingOperations(recordId, moduleName);
		APIResponse<ActionHandler> response = recordLockingOperations.unlockRecord(lockId);
		if (response != null)
		{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			unlockRecord(recordId, moduleAPIName, lockId);
		}
		catch (Exception e)
		{
			e.printStackTrace();
