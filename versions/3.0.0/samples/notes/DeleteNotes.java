...
{
	public static void deleteNotes(List<String> notesId) throws Exception
	{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			ArrayList<String> notesId = new ArrayList<String>(Arrays.asList("34770616153001", "34770616153002"));
			deleteNotes(notesId);
		}
		catch (Exception e)
		{
