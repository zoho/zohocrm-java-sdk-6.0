...
public class UploadAttachments
{
	public static void uploadAttachments(String moduleAPIName, Long recordId, String absoluteFilePath) throws Exception
	{
		...
		APIResponse<ActionHandler> response = attachmentsOperations.uploadAttachments(recordId, moduleAPIName, fileBodyWrapper);
		if (response != null)
		{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			Long attachmentId = 3477001l;
			String absoluteFilePath = "/Users/file.png";
