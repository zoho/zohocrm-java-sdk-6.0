...
{
	public static void getDownloadAttchmentDetails(String module, Long recordId, Long userId, String messageId, String destinationFolder, String id) throws Exception
	{
		...
		paramInstance.add(GetDownloadAttachmentsDetailsParam.ID, id);
		paramInstance.add(GetDownloadAttachmentsDetailsParam.NAME, "");
	...
	public static void main(String[] args)
	{
		try
		{
			...
			getDownloadAttchmentDetails(module, recordId, userId, messageId, destinationFolder, id);
		}
		catch (Exception e)
		{
			e.printStackTrace();
