...
public class ActionWrapper implements Model, ActionHandler
{
	 ...
	 */
	public List<ActionResponse> getScoringRules()
	{
	 ...
	 * @param scoringRules An instance of List<ActionResponse>
	 */
	public void setScoringRules(List<ActionResponse> scoringRules)
	{
