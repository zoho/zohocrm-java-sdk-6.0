...
import com.zoho.crm.api.globalpicklists.GlobalPicklistsOperations.DeleteGlobalPicklistsParam;
import com.zoho.crm.api.globalpicklists.SuccessResponse;
import com.zoho.crm.api.util.APIResponse;
import com.zoho.crm.api.util.Model;

public class DeleteGlobalPicklists
{
	public static void deleteGlobalPicklists() throws Exception
	{
		GlobalPicklistsOperations globalPicklistsOperations = new GlobalPicklistsOperations();
		ParameterMap paramInstance = new ParameterMap();
		paramInstance.add(DeleteGlobalPicklistsParam.IDS, "34775007");
		APIResponse<ActionHandler> response = globalPicklistsOperations.deleteGlobalPicklists(paramInstance);
		if (response != null)
		{
