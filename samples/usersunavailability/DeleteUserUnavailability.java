...
public class DeleteUserUnavailability
{
	public static void deleteUserUnavailability(String id) throws Exception
	{
		UsersUnavailabilityOperations usersOperations = new UsersUnavailabilityOperations();
		APIResponse<ActionHandler> response = usersOperations.deleteUserUnavailability(id);
		if (response != null)
		{
