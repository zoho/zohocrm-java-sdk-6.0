...
public class GetFeatureDetail
{
	public static void getFeatureDetail(String featureAPIName) throws Exception
	{
		...
		APIResponse<ResponseHandler> response = featuresOperations.getFeatureDetail(featureAPIName, paramInstance);
		if (response != null)
		{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			String featureAPIName = "data_sharing_rules";
			getFeatureDetail(featureAPIName);
		}
		catch (Exception e)
		{
			e.printStackTrace();
