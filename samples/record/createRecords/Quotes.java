...
public class Quotes
{
	public static void createQuotes(String moduleAPIName) throws Exception
	{
		...
		lineItemProduct.setId(44024800954344l);
...
//		inventoryLineItem.addKeyValue("Product_Category_1", "hardware");
		...
		productLineTax.setId(44024800020810l);
	...
	public static void main(String[] args)
	{
		try
		{
			...
			Token token = new OAuthToken.Builder().clientID("clientID").clientSecret("clientSecret").grantToken("gratntoken.").build();
