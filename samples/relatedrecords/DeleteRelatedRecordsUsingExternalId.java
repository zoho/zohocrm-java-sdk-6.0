...
import com.zoho.crm.api.relatedrecords.RelatedRecordsOperations.DeleteRelatedRecordsUsingExternalIDHeader;
...
public class DeleteRelatedRecordsUsingExternalId
{
	public static void deleteRelatedRecordsUsingExternalId(String moduleAPIName, String externalValue, String relatedListAPIName, List<String> relatedListIds) throws Exception
	{
		...
		headerInstance.add(DeleteRelatedRecordsUsingExternalIDHeader.X_EXTERNAL, xExternal);
