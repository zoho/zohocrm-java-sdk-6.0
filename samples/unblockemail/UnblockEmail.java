...
public class UnblockEmail
{
	public static void unblockEmail(String moduleAPIName, Long id) throws Exception
	{
		...
		APIResponse<ActionHandler> response = unblockEmailOperations.unblockEmail(id, request);
		if (response != null)
		{
