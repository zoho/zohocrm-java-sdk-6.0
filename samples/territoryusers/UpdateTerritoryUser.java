...
{
	public static void updateTerritoryuser(Long user, Long territory) throws Exception
	{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			Long territoryId = 440248001305227l;
			Long user = 440248001305249l;
			updateTerritoryuser(user, territoryId);
		}
		catch (Exception e)
		{
			e.printStackTrace();
