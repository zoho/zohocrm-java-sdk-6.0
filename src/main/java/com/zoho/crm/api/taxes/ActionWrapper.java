...
public class ActionWrapper implements Model, ActionHandler
{
	...
	/**
	 * The method to get the value of orgTaxes
	 * @return An instance of ActionResponse
	 */
	public ActionResponse getOrgTaxes()
	{
	 ...
	 */
	public void setOrgTaxes(ActionResponse orgTaxes)
	{
		 this.orgTaxes = orgTaxes;

		 this.keyModified.put("org_taxes", 1);
